...
export default class VideoPlayer extends Component {
    ...
    */
    ...
    _toggleFullscreen() {
        ...
        let dimensions = state.isFullscreen ? { width, height } : this.props.style || {}

        this.styles = {
            ...this.styles,
            containerStyle: { ...this.styles.containerStyle, ...dimensions }
        };
    ...
    */
    ...
    toggleOverlay = (call) => this.setState({ visible: !this.state.visible }, call ? call : () => { })

    render() {
        let { isFullscreen } = this.state
        let { containerStyle } = this.styles
        return (
            <>
                <TouchableOpacity
                ...
                >
                    <Icon name="play" size={50} color="#fff" style={{
                        position: 'absolute',
                        zIndex: 9999
                    }} />
                    <View style={{
                ...
                <Overlay
                    ...
                    overlayStyle={{
                        width: isFullscreen ? containerStyle.height : containerStyle.width,
                        height: isFullscreen ? containerStyle.width : containerStyle.height,
                        margin: 0,
                        padding: 0,
                        ...this.state.styleFullScreen
                    }}>
                    <TouchableWithoutFeedback
